...
Приложение работает офлайн, поэтому обращения к сети не выполняются:
ответы формируются из заранее подготовленных данных. Названия и структура
ответов совпадают с тем, что ожидает курс.
"""
