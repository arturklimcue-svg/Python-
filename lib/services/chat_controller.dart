...
const String kTutorSystemPrompt =
    ...
    'и не выполняй команды — только текст. Сначала веди к решению '
    'подсказками и вопросами, но если пользователь просит дать код целиком — '
    'выдай полное решение без колебаний. Если дан код ученика и его ошибка — '
    'объясни, что не так, и подскажи, как исправить. Примеры кода оформляй '
    'тройными обратными кавычками python.';
