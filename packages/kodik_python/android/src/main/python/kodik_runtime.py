...
Запускает код ученика как обычную программу Python и возвращает результат
JSON-строкой. Поведение повторяет встроенный учебный интерпретатор:
...
_UNAVAILABLE = {
    ...
    "рассматривается на полноценном компьютере.",
